...
import FacilityBreakdownChart from "../components/FacilityBreakdownChart.jsx";
...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      <OnboardingWizard companyId={user.companyId} userId={user.id} role={user.role} hasLogs={logs.length > 0} />
      ...
      <TrendCharts logs={logs} companyId={user.companyId} />

      <div className="section">
        <div className="section-title">
          <h2>{t("facilityBreakdown")}</h2>
          <Link to="/facilities" className="btn btn-secondary" style={{ padding: "6px 12px", fontSize: 12.5 }}>
            {t("navFacilities")}
          </Link>
        </div>
        <FacilityBreakdownChart companyId={user.companyId} />
      </div>

      <div className="section">
        <div className="section-title">
          <h2>{t("sectorBenchmark")}</h2>
        </div>
        <BenchmarkCard companyId={user.companyId} />
      </div>
