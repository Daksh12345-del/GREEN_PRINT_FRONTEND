...
export const getTimeseries = (companyId, granularity) =>
  request(withQuery("/kpis/timeseries", { companyId, granularity }));
export const getFacilityBreakdown = (companyId) => request(withQuery("/kpis/by-facility", { companyId }));
export const getBenchmark = (companyId) => request(withQuery("/kpis/benchmark", { companyId }));
